const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./capacitor-share-intent.js","../com/app.js","./rolldown-runtime.js","../shells/boot-index.js","../fest/core.js","../shells/boot-history-base.js","../com/service.js","../fest/veela.js","./capacitor-permissions.js","./capacitor-clipboard-asset.js","./frontend-debug-capture.js","./sw-handling.js","./log-sanitizer.js","./workcenter-command-wire.js","./sw-page-bridge.js","./sku-ingress.js","./ViewTransferRouting.js"])))=>i.map(i=>d[i]);
import { Or as __vitePreload, vr as loadAsAdopted } from "../com/app.js";
import { t as withTimeout } from "../fest/core.js";
import { $t as isClipboardHubBootstrapEnabled, A as initializeLayers, An as shouldConnectViaFleetGateway, Bt as getAirPadHandshakeArchetype, C as loadStyleSystem, Cn as isGuestPrivateLanIpv4, D as shouldDeferCrxHubSocketBootstrap, Dn as normalizeWireNodeIdForWire, E as loadSettings, En as isOnHomeFleetLanPageHost, Ft as applyAirpadRuntimeFromAppSettings, Gt as getAssociatedClientToken, Ht as getAirPadPeerInstanceId, It as getAccessToken, J as initializeRegistries, Jt as getClipboardPushIntervalMs, K as darkTheme, Kt as getClientAccessToken, Lt as getAirPadClientId, Mn as shouldPreferWanGatewayForAirpad, Nn as CWSP_DEFAULT_HTTPS_PORTS, O as DEFAULT_SETTINGS, On as sanitizeFleetRouteTarget, Pn as CWSP_DEFAULT_HTTP_PORTS, Qt as isApplyRemoteClipboardToDeviceEnabled, Rt as getAirPadDirectTargetUrl, S as writeClipboardTextToDevice, Sn as isGatewayHttpsOrigin, T as ensureCapacitorCwspSettingsSeeded, Tn as isOffHomeFleetNetwork, Un as splitConnectHostList, Ut as getAirPadTransportMode, Vt as getAirPadHandshakeConnectionType, W as ShellRegistry, Wt as getAirPadTransportSecret, X as startImplicitViewMessagingBridge, Xt as getRemoteProtocol, Y as lightTheme, Yt as getRemoteHost, Zt as getRemoteRouteTarget, _ as annotatePacketWireTime64, _t as pickEnabledView, an as isShellRemoteClipboardBridgeEnabled, b as readClipboardTextFromDevice, bn as isFleetDeskWireNodeId, d as ensureAppLayers, en as isClipboardSenderAllowedForInbound, f as annotatePacketWireHash, fn as isCapacitorCwsNativeShell, g as shouldAnnotateCoordinatorPayload, gn as DEFAULT_DESK_WIRE_NODE_ID, gt as isEnabledView, h as annotateCoordinatorPayload, in as isPushLocalClipboardToLanEnabled, jn as shouldFleetDeskGatewayProbeFallbacks, kn as sanitizeFleetSelfWireNodeId, ln as initCwsNativeBridge, m as packetWireDedupeGuard, mt as serviceChannels, nn as isNeutralinoNodeClipboardHubOwned, on as setAirpadCredentialInvalidator, p as inferWireDedupeCategory, q as defaultTheme, qt as getClipboardBroadcastWireTargets, rn as isPreferNativeWebsocketEnabled, tn as isMaintainHubSocketConnectionEnabled, un as invokeCwsNative, w as applyTheme, wn as isHomeFleetLanHost, x as writeClipboardImageToDevice, xn as isFleetGatewayWireNodeId, y as isCapacitorNativeShell, yn as isAssociableFleetWireNodeId, zt as getAirPadEndpointUrl } from "../shells/boot-index.js";
	...
	async boot(container, config) {
		...
		try {
			...
			if (!(() => {
				...
				}, __vite__mapDeps([11,1,2,3,4,5,6,7,12,13,14,15,16]), import.meta.url);
