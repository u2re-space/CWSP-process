const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./frontend-debug-capture.js","./rolldown-runtime.js","../shells/boot-index.js","../com/app.js","../fest/core.js","../shells/boot-history-base.js","../com/service.js","../fest/veela.js","./sw-handling.js","./LogSanitizer.js","./sku-ingress.js","./ViewTransferRouting.js"])))=>i.map(i=>d[i]);
import { Dr as __vitePreload, vr as loadAsAdopted } from "../com/app.js";
import { t as withTimeout } from "../fest/core.js";
import { An as splitConnectHostList, At as getAirPadPeerInstanceId, Bt as isApplyRemoteClipboardToDeviceEnabled, C as ensureCapacitorCwspSettingsSeeded, Ct as applyAirpadRuntimeFromAppSettings, Dt as getAirPadEndpointUrl, E as DEFAULT_SETTINGS, Et as getAirPadDirectTargetUrl, Ft as getClipboardBroadcastWireTargets, G as defaultTheme, Gt as isPreferNativeWebsocketEnabled, H as ShellRegistry, Ht as isClipboardSenderAllowedForInbound, It as getClipboardPushIntervalMs, J as startImplicitViewMessagingBridge, Jt as setAirpadCredentialInvalidator, K as initializeRegistries, Kt as isPushLocalClipboardToLanEnabled, Lt as getRemoteHost, Mt as getAirPadTransportSecret, Nt as getAssociatedClientToken, O as initializeLayers, Ot as getAirPadHandshakeArchetype, Pt as getClientAccessToken, Qt as invokeCwsNative, Rt as getRemoteProtocol, S as applyTheme, T as shouldDeferCrxHubSocketBootstrap, Tt as getAirPadClientId, Ut as isMaintainHubSocketConnectionEnabled, Vt as isClipboardHubBootstrapEnabled, W as darkTheme, Wt as isNeutralinoNodeClipboardHubOwned, Zt as initCwsNativeBridge, _ as isCapacitorNativeShell, _n as shouldConnectViaFleetGateway, at as pickEnabledView, b as writeClipboardTextToDevice, bn as CWSP_DEFAULT_HTTPS_PORTS, cn as isFleetGatewayWireNodeId, d as inferWireDedupeCategory, dn as isHomeFleetLanHost, en as isCapacitorCwsNativeShell, f as packetWireDedupeGuard, fn as isOffHomeFleetNetwork, gn as sanitizeFleetSelfWireNodeId, h as annotatePacketWireTime64, hn as sanitizeFleetRouteTarget, it as isEnabledView, jt as getAirPadTransportMode, kt as getAirPadHandshakeConnectionType, l as ensureAppLayers, ln as isGatewayHttpsOrigin, m as shouldAnnotateCoordinatorPayload, mn as normalizeWireNodeIdForWire, nt as serviceChannels, on as isAssociableFleetWireNodeId, p as annotateCoordinatorPayload, pn as isOnHomeFleetLanPageHost, q as lightTheme, qt as isShellRemoteClipboardBridgeEnabled, rn as DEFAULT_DESK_WIRE_NODE_ID, sn as isFleetDeskWireNodeId, u as annotatePacketWireHash, un as isGuestPrivateLanIpv4, v as readClipboardTextFromDevice, vn as shouldFleetDeskGatewayProbeFallbacks, w as loadSettings, wt as getAccessToken, x as loadStyleSystem, xn as CWSP_DEFAULT_HTTP_PORTS, y as writeClipboardImageToDevice, yn as shouldPreferWanGatewayForAirpad, zt as getRemoteRouteTarget } from "../shells/boot-index.js";
	...
	async boot(container, config) {
		...
		try {
			...
			if (!(() => {
				...
				}, __vite__mapDeps([8,3,1,2,4,5,6,7,9,10,11]), import.meta.url);
