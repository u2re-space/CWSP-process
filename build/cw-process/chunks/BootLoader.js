const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./capacitor-share-intent.js","../com/app.js","./rolldown-runtime.js","../shells/boot-index.js","../fest/core.js","../shells/boot-history-base.js","../com/service.js","../fest/veela.js","./capacitor-permissions.js","./capacitor-clipboard-asset.js","./frontend-debug-capture.js","./sw-handling.js","../views/viewer.js","./log-sanitizer.js","./sw-page-bridge.js","./workcenter-command-wire.js","./ViewTransferRouting.js"])))=>i.map(i=>d[i]);
import { Or as __vitePreload, vr as loadAsAdopted } from "../com/app.js";
import { t as withTimeout } from "../fest/core.js";
import { $t as isApplyRemoteClipboardToDeviceEnabled, A as initializeLayers, An as sanitizeFleetSelfWireNodeId, Bt as getAirPadEndpointUrl, C as loadStyleSystem, Cn as isGatewayHttpsOrigin, D as shouldDeferCrxHubSocketBootstrap, Dn as isOnHomeFleetLanPageHost, E as loadSettings, En as isOffHomeFleetNetwork, Fn as CWSP_DEFAULT_HTTP_PORTS, Gt as getAirPadTransportSecret, Ht as getAirPadHandshakeConnectionType, It as applyAirpadRuntimeFromAppSettings, J as initializeRegistries, Jt as getClipboardBroadcastWireTargets, K as darkTheme, Kt as getAssociatedClientToken, Lt as getAccessToken, Mn as shouldFleetDeskGatewayProbeFallbacks, Nn as shouldPreferWanGatewayForAirpad, O as DEFAULT_SETTINGS, On as normalizeWireNodeIdForWire, Pn as CWSP_DEFAULT_HTTPS_PORTS, Qt as getRemoteRouteTarget, Rt as getAirPadClientId, S as writeClipboardTextToDevice, Sn as isFleetGatewayWireNodeId, T as ensureCapacitorCwspSettingsSeeded, Tn as isHomeFleetLanHost, Ut as getAirPadPeerInstanceId, Vt as getAirPadHandshakeArchetype, W as ShellRegistry, Wn as splitConnectHostList, Wt as getAirPadTransportMode, X as startImplicitViewMessagingBridge, Xt as getRemoteHost, Y as lightTheme, Yt as getClipboardPushIntervalMs, Zt as getRemoteProtocol, _ as annotatePacketWireTime64, _n as DEFAULT_DESK_WIRE_NODE_ID, _t as isEnabledView, an as isPushLocalClipboardToLanEnabled, b as readClipboardTextFromDevice, bn as isAssociableFleetWireNodeId, d as ensureAppLayers, dn as invokeCwsNative, en as isClipboardHubBootstrapEnabled, f as annotatePacketWireHash, g as shouldAnnotateCoordinatorPayload, h as annotateCoordinatorPayload, ht as serviceChannels, in as isPreferNativeWebsocketEnabled, jn as shouldConnectViaFleetGateway, kn as sanitizeFleetRouteTarget, m as packetWireDedupeGuard, nn as isMaintainHubSocketConnectionEnabled, on as isShellRemoteClipboardBridgeEnabled, p as inferWireDedupeCategory, pn as isCapacitorCwsNativeShell, q as defaultTheme, qt as getClientAccessToken, rn as isNeutralinoNodeClipboardHubOwned, sn as setAirpadCredentialInvalidator, tn as isClipboardSenderAllowedForInbound, un as initCwsNativeBridge, vt as pickEnabledView, w as applyTheme, wn as isGuestPrivateLanIpv4, x as writeClipboardImageToDevice, xn as isFleetDeskWireNodeId, y as isCapacitorNativeShell, zt as getAirPadDirectTargetUrl } from "../shells/boot-index.js";
	...
	async boot(container, config) {
		...
		try {
			...
			if (isCapacitorCwsNativeShell()) {
				...
				__vitePreload(() => import("../com/app.js").then((n) => n.rr).then((mod) => mod.ensureNativeStorageProvide()), __vite__mapDeps([1,2]), import.meta.url).catch(() => void 0);
			}
			try {
				...
				}, __vite__mapDeps([10,2,3,1,4,5,6,7]), import.meta.url);
			...
			if (!(() => {
				...
				}, __vite__mapDeps([11,1,2,12,3,4,5,6,7,13,14,15,16]), import.meta.url);
