const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../com/app.js","./rolldown-runtime.js","./ViewTransferRouting.js","../shells/boot-index.js","../fest/core.js","../shells/boot-history-base.js","../com/service.js","../fest/veela.js","./LogSanitizer.js"])))=>i.map(i=>d[i]);
import { r as __exportAll } from "./rolldown-runtime.js";
const __vitePreload = (baseModule) => Promise.resolve().then(() => baseModule());
import { Bn as resolveProcessIngressKind, Dr as sinkToDestination, Er as sinkToAction, Ln as peekProcessIngressSettings, Tr as resolveOpenPolicy, br as peekOpenPolicy, hr as inferIngressChannels, jr as surfaceForSku, mr as classifyOpenKindFromPayload } from "../shells/boot-index.js";
		...
		(async () => {
			try {
				...
				const { peekOpenPolicy, rememberOpenPolicyFromSettings, resolveOpenPolicy } = await __vitePreload(async () => {
					const { peekOpenPolicy, rememberOpenPolicyFromSettings, resolveOpenPolicy } = await import("../shells/boot-index.js").then((n) => n.yr);
					return {
						peekOpenPolicy,
