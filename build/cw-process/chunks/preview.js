...
import { it as isEnabledView } from "../shells/boot-index.js";
...
var MinimalShell = class extends ShellBase {
	...
	*/
	...
	setupAdminDoorButton(root) {
		...
		btn.addEventListener("click", () => {
			__vitePreload(async () => {
				const { loadSettings } = await import("../shells/boot-index.js").then((n) => n.gt);
				return { loadSettings };
			...
			}, __vite__mapDeps([7,1]), import.meta.url).then(({ openAdminDoorFromCore }) => {
	...
	*/
	renderView(element) {
		...
		if (previousId && previousId !== this.currentView.value && this.loadedViews.has(previousId)) {
			...
			if (previousId === "history" && this.currentView.value !== "history") try {
				if (globalThis.__CWSP_TRANSFER_HISTORY_UI_ACTIVE__) __vitePreload(() => import("./transfer-history-runtime.js").then((m) => m.setTransferHistoryUiActive(false)), __vite__mapDeps([8,2,1]), import.meta.url).catch(() => void 0);
			} catch {}
		}
	...
	async mount(container) {
		...
		__vitePreload(() => import("./capacitor-permissions.js").then((n) => n.t).then((m) => m.ensureCapacitorPermissions()), __vite__mapDeps([9,1]), import.meta.url).catch(() => {});
		__vitePreload(() => import("./capacitor-share-intent.js").then((m) => m.installCapacitorShareIntentBridge()), __vite__mapDeps([10,2,1,0,3,4,5,6,9]), import.meta.url).catch(() => {});
		__vitePreload(() => import("./capacitor-clipboard-asset.js").then((m) => m.installCapacitorClipboardAssetBridge()), __vite__mapDeps([11,9,1]), import.meta.url).catch(() => {});
	}
};
/**
