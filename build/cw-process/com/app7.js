...
var extractPdf = async (file) => {
	const [{ getDocument, GlobalWorkerOptions }, worker] = await Promise.all([__vitePreload(() => import("../vendor/pdfjs-dist.js"), __vite__mapDeps([10,6]), import.meta.url), __vitePreload(() => import("../vendor/pdfjs-dist2.js"), [], import.meta.url)]);
...
var extractDocx = async (file) => {
	const mammothModule = await __vitePreload(() => import("../vendor/underscore.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), __vite__mapDeps([11,1]), import.meta.url);
