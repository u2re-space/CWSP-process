import { St as preloadStyle, z as scheduleEnsureHostStyles } from "../fest/core.js";
import { H as resolveOverlayHost, J as GLitElement, V as registerTransientOverlay, X as property, Y as defineElement, Z as H, bt as addEvent, k as placeOverlay, yt as MOCElement } from "../fest/core4.js";
import { $ as uploadFile, C as getMimeTypeByFilename, Ct as setOpfsSupportEnabled, E as handleIncomingEntries, G as remove, I as openDirectory, Tt as isUserScopePath, U as refreshMappedStorageRoots, V as readFile, Y as resolveRootHandle, _ as getDirectoryHandle, bt as isOpfsCapabilityAvailable, d as downloadFile, i as copyFromOneHandlerToAnother, nt as asProvidedFile, tt as writeFile, wt as isIdbScopePath, xt as isOpfsSupportEnabled, y as getFileHandle, z as provide } from "../fest/core5.js";
import { f as ref, i as affected, u as observe } from "../fest/object.js";
import { C as normalizeVirtualPath, S as buildExplorerDragPayload, d as readNativeStorageFile, g as shareNativeStorageFile, h as resolveNativeStorageUri, i as getAllFilesStatus, l as pickBrowserDirectory, m as resolveNativeStorageRealPath, n as copyNativeStorageImage, o as isNativeStorageAvailable, p as requestAllFilesAccess, t as canShowDirectoryPicker, u as pickSafTree, y as writeNativeClipboardImage } from "./app.js";
import { a as unregisterFsBackend, c as removeDirectoryMount, n as listVirtualRootEntriesFromRouter, o as addDirectoryMount, r as resolveFsBackend, s as listExplorerMounts, t as ensureDefaultFsBackends } from "./app2.js";
import "./app5.js";
import "../fest/icon.js";
...
var writeImage = async (file, virtualPath = "") => {
	...
	if (isCapacitorNative()) {
		try {
			if (await writeNativeClipboardImage(await fileToBase64Url(png), png.type || "image/png", png.name)) return true;
		} catch {}
		return false;
	}
	await waitClipboard();
				...
				case "movePath":
					...
					if (actionId === "rename") {
						...
						if (next && next !== itemName) {
							...
							else if (item?.kind === "file") if (isWorkspacePath(abs)) await this.renameUserFile(abs ?? "", next ?? "");
