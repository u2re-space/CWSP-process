const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../shells/boot-index.js","./rolldown-runtime.js","../shells/boot-history-base.js","../com/app.js","../fest/core.js","../com/service.js","../fest/veela.js","./sku-ingress.js","./sw-handling.js","./log-sanitizer.js","./ViewTransferRouting.js"])))=>i.map(i=>d[i]);
const __vitePreload = (baseModule) => Promise.resolve().then(() => baseModule());
import { Vn as splitMultiValueList, u as isCapacitorNative } from "../shells/boot-index.js";
		...
		(async () => {
			...
			try {
				const [{ loadSettings }, ws, { classifyOpenKindFromPayload }, ingress] = await Promise.all([
					__vitePreload(() => import("../shells/boot-index.js").then((n) => n.Tt), __vite__mapDeps([0,1,2,3,4,5,6]), import.meta.url),
					__vitePreload(() => import("../shells/boot-index.js").then((n) => n.c), __vite__mapDeps([0,1,2,3,4,5,6]), import.meta.url),
					__vitePreload(() => import("../shells/boot-index.js").then((n) => n.Or), __vite__mapDeps([0,1,2,3,4,5,6]), import.meta.url),
					__vitePreload(() => import("../shells/boot-index.js").then((n) => n.Xn), __vite__mapDeps([0,1,2,3,4,5,6]), import.meta.url)
				]);
