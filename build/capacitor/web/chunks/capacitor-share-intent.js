const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../shells/boot-index.js","./rolldown-runtime.js","../shells/boot-history-base.js","../com/app.js","../fest/core.js","../com/service.js","../fest/veela.js","./sku-ingress.js","./sw-handling.js","./log-sanitizer.js","./ViewTransferRouting.js","./capacitor-settings-permissions.js","./capacitor-permissions.js"])))=>i.map(i=>d[i]);
const __vitePreload = (baseModule) => Promise.resolve().then(() => baseModule());
import { Vn as splitMultiValueList } from "../shells/boot-index.js";
		...
		(async () => {
			...
			try {
				...
				if (row.backgroundClipboard) {
					...
					}, __vite__mapDeps([11,1,12]), import.meta.url);
