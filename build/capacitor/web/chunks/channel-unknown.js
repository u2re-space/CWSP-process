...
import { B as reinitializeRegistry, Ct as getCachedComponent, I as clearIconCaches, L as debugIconSystem, R as testIconRacing, Rt as createFileHandler, Tn as H, V as clearAllCache, an as createTemplateManager, ar as __vitePreload, qn as loadAsAdopted, sn as getSpeechPrompt, z as ensureStyleSheet } from "../com/app.js";
import { $n as enqueuePendingMessage, Qn as createMessageWithOverrides, cr as BROADCAST_CHANNELS, er as hasPendingMessages, it as settleIngressPaintForMinimalShell, nr as processInitialContent, or as unifiedMessaging, rr as registerComponent, tr as initializeComponent, ur as getBroadcastChannelForDestination, yt as loadSettings } from "../shells/boot-index.js";
	...
	*/
	...
	const renderHistoryView = async () => {
      ...
      <span>Loading History...</span>
		...
		content.append(loadingElement);
		try {
			const historyManager = (await getCachedComponent("history-manager", () => __vitePreload(() => import("../com/app.js").then((n) => n.dn), __vite__mapDeps([3,1]), import.meta.url), { componentName: "HistoryManager" })).component.createHistoryManager();
