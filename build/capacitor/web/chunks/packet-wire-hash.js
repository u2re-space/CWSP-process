const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./cws-bridge2.js","./rolldown-runtime.js","../fest/core3.js","../fest/core2.js","../fest/uniform.js","../assets/index-CU5eF_0S.js","./ecosystem-skus.js","./UniformInterop.js","./names.js","./airpad-cwsp-client-parity.js","./multi-value-list.js","../vendor/@capacitor_core2.js","./crx-control-session2.js","../fest/core4.js","../fest/core.js","../fest/object.js","../fest/core5.js"])))=>i.map(i=>d[i]);
import { t as __vitePreload } from "../assets/index-CU5eF_0S.js";
import { I as JSOX, v as writeFileSmart } from "../fest/core4.js";
...
import { a as patchNativeUnifiedSettingsDetailed, i as isCwsNativeIpcAvailable, n as getNativeUnifiedSettings, r as initCwsNativeBridge } from "./cws-bridge2.js";
...
var persistProcessIngressNativeSnapshot = async (settings) => {
	...
	try {
		const { invokeCwsNative } = await __vitePreload(async () => {
			const { invokeCwsNative } = await import("./cws-bridge2.js").then((n) => n.t);
...
var readCrxControlSessionTokenAsync = async () => {
	...
	try {
		return await (await __vitePreload(() => import("./crx-control-session2.js"), __vite__mapDeps([12,5,6,1]), import.meta.url)).getCrxControlSessionToken() || "";
	} catch {
		return "";
	}
};
var webnativeControl = async (path, init) => {
	try {
		...
		if ((res.status === 401 || res.status === 403) && (pageIsPublicHttps || pageIsChromeExtension)) try {
			...
			if (pageIsChromeExtension) __vitePreload(() => import("./crx-control-session2.js").then((m) => m.clearCrxControlSession()), __vite__mapDeps([12,5,6,1]), import.meta.url).catch(() => void 0);
			globalThis.dispatchEvent(new CustomEvent("cwsp-control-unauthorized", { detail: {
				status: res.status,
				path
			} }));
...
var loadLureFs = () => {
	...
	if (!lureFsPromise) lureFsPromise = __vitePreload(() => import("../fest/core4.js").then((n) => n.t).then((m) => ({
		...
		readFile: m.readFile
	})), __vite__mapDeps([13,1,5,6,14,3,15,16,4]), import.meta.url);
