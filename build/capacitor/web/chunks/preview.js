...
import { In as affected, Tn as H, ar as __vitePreload } from "../com/app.js";
...
var MinimalShell = class extends ShellBase {
	...
	*/
	renderView(element) {
		...
		if (previousId && previousId !== this.currentView.value && this.loadedViews.has(previousId)) {
			...
			if (previousId === "history" && this.currentView.value !== "history") try {
				if (globalThis.__CWSP_TRANSFER_HISTORY_UI_ACTIVE__) __vitePreload(() => import("./transfer-history-runtime.js").then((m) => m.setTransferHistoryUiActive(false)), __vite__mapDeps([8,3,1]), import.meta.url).catch(() => void 0);
			} catch {}
		}
	...
	async mount(container) {
		...
		__vitePreload(() => import("./capacitor-share-intent.js").then((m) => m.installCapacitorShareIntentBridge()), __vite__mapDeps([10,3,1,0,2,4,5,6,9]), import.meta.url).catch(() => {});
