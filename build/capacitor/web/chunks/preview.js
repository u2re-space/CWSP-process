...
var MinimalShell = class extends ShellBase {
	...
	*/
	renderView(element) {
		...
		if (previousId && previousId !== this.currentView.value && this.loadedViews.has(previousId)) {
			...
			if (previousId === "history" && this.currentView.value !== "history") try {
				if (globalThis.__CWSP_TRANSFER_HISTORY_UI_ACTIVE__) __vitePreload(() => import("./transfer-history-runtime.js").then((m) => m.setTransferHistoryUiActive(false)), __vite__mapDeps([22,2,3,1]), import.meta.url).catch(() => void 0);
			} catch {}
		}
	...
	flushShownView(element) {
		...
		}), __vite__mapDeps([4,1,2,3,5,6,7,8,9]), import.meta.url).catch(() => {});
	}
	applyTheme(theme) {
	...
	async mount(container) {
		...
		__vitePreload(() => import("./capacitor-share-intent.js").then((m) => m.installCapacitorShareIntentBridge()), __vite__mapDeps([24,2,3,1,14,23]), import.meta.url).catch(() => {});
