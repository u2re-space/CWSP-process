...
import { $t as isNeutralinoNodeClipboardHubOwned, A as initializeLayers, An as CWSP_DEFAULT_HTTPS_PORTS, Bn as splitConnectHostList, Bt as getAirPadTransportMode, C as loadStyleSystem, Cn as isOnHomeFleetLanPageHost, D as shouldDeferCrxHubSocketBootstrap, Dn as shouldConnectViaFleetGateway, E as loadSettings, En as sanitizeFleetSelfWireNodeId, Ft as getAirPadDirectTargetUrl, Gt as getClipboardPushIntervalMs, Ht as getAssociatedClientToken, It as getAirPadEndpointUrl, J as initializeRegistries, Jt as getRemoteRouteTarget, K as darkTheme, Kt as getRemoteHost, Lt as getAirPadHandshakeArchetype, Mt as applyAirpadRuntimeFromAppSettings, Nt as getAccessToken, O as DEFAULT_SETTINGS, On as shouldFleetDeskGatewayProbeFallbacks, Pt as getAirPadClientId, Qt as isMaintainHubSocketConnectionEnabled, Rt as getAirPadHandshakeConnectionType, S as writeClipboardTextToDevice, Sn as isOffHomeFleetNetwork, T as ensureCapacitorCwspSettingsSeeded, Tn as sanitizeFleetRouteTarget, Ut as getClientAccessToken, Vt as getAirPadTransportSecret, W as ShellRegistry, Wt as getClipboardBroadcastWireTargets, X as startImplicitViewMessagingBridge, Xt as isClipboardHubBootstrapEnabled, Y as lightTheme, Yt as isApplyRemoteClipboardToDeviceEnabled, Zt as isClipboardSenderAllowedForInbound, _ as annotatePacketWireTime64, _n as isFleetDeskWireNodeId, b as readClipboardTextFromDevice, bn as isGuestPrivateLanIpv4, d as ensureAppLayers, dt as serviceChannels, en as isPreferNativeWebsocketEnabled, f as annotatePacketWireHash, g as shouldAnnotateCoordinatorPayload, gn as isAssociableFleetWireNodeId, h as annotateCoordinatorPayload, jn as CWSP_DEFAULT_HTTP_PORTS, kn as shouldPreferWanGatewayForAirpad, ln as isCapacitorCwsNativeShell, m as packetWireDedupeGuard, mt as pickEnabledView, nn as isShellRemoteClipboardBridgeEnabled, on as initCwsNativeBridge, p as inferWireDedupeCategory, pn as DEFAULT_DESK_WIRE_NODE_ID, pt as isEnabledView, q as defaultTheme, qt as getRemoteProtocol, rn as setAirpadCredentialInvalidator, sn as invokeCwsNative, tn as isPushLocalClipboardToLanEnabled, vn as isFleetGatewayWireNodeId, w as applyTheme, wn as normalizeWireNodeIdForWire, x as writeClipboardImageToDevice, xn as isHomeFleetLanHost, y as isCapacitorNativeShell, yn as isGatewayHttpsOrigin, zt as getAirPadPeerInstanceId } from "../shells/boot-index.js";
	...
	async boot(container, config) {
		...
		try {
			...
			if (!(() => {
				...
				}, __vite__mapDeps([11,4,1,2,3,5,6,7,12,13,14]), import.meta.url);
