const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./frontend-debug-capture.js","./rolldown-runtime.js","../shells/boot-index.js","../shells/boot-history-base.js","../com/app.js","../fest/core.js","../com/service.js","../fest/veela.js","./sw-handling.js","./sku-ingress.js","./LogSanitizer.js"])))=>i.map(i=>d[i]);
import { Gn as __vitePreload, Nn as loadAsAdopted } from "../com/app.js";
	...
	async boot(container, config) {
		...
		try {
			...
			if (!(() => {
				...
				}, __vite__mapDeps([8,3,4,1,2,5,6,7,9,10]), import.meta.url);
