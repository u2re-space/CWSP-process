const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./core5.js","../chunks/rolldown-runtime.js","../assets/index-CU5eF_0S.js","../chunks/ecosystem-skus.js","./core2.js","./object.js","./uniform.js"])))=>i.map(i=>d[i]);
...
var getNativeBackend = () => {
	...
	}, __vite__mapDeps([0,1,2,3,4,5,6]), import.meta.url).then(({ readFile, removeFile, writeFile }) => ({
		async read(path) {
