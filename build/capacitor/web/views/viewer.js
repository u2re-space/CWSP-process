const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../vendor/marked.js","../chunks/rolldown-runtime.js","../vendor/marked-katex-extension.js","../vendor/katex.js","../chunks/DocxExport.js","../chunks/BootLoader.js","../com/app.js","../fest/core.js","../shells/boot-index.js","../shells/boot-history-base.js","../com/service.js","../fest/veela.js","../shells/preference.js","../chunks/capacitor-settings-permissions.js","../chunks/capacitor-permissions.js","../chunks/sku-ingress.js"])))=>i.map(i=>d[i]);
...
import { At as findEntryRelPath, B as ensureStyleSheet, Bt as relPathCandidates, Ft as originalRelFromRef, Gt as decodeBase64ToBytes, Ht as saveMarkdownBlob, It as pickAssetDirectory, Jt as parseDataUrl, Kt as isBase64Like, Lt as pickMarkdownFile, Mn as H, Mt as isMarkdownRelativeRef, Nt as mountPickedDirectory, Pt as observeFileSystemHandle, Qt as getDir, Rt as pickSidecarDirectoryFiles, V as reinitializeRegistry, Vt as resolveFileUnderDirectory, Xn as affected, cn as createProtocolEnvelope, en as isVirtualFsPath, in as provide, jt as indexDirectoryFiles, lr as removeAdopted, nn as normalizePath, nr as ref, or as loadAsAdopted, qt as normalizeDataAsset, rn as openDirectory, tn as matchMappedRoot, ur as __vitePreload, zt as provideBoundRelative } from "../com/app.js";
import { Gn as sendProtocolMessage, Y as ingressStampWasSuperseded, dr as resolveHostOpenPolicy, er as classifyOpenKind, ir as looksLikePreviewableBinary, lr as rememberOpenPolicyFromSettings, pr as resolveOpenPolicy, xt as loadSettings } from "../shells/boot-index.js";
		...
		*/
		...
		async handleExportDocx() {
			...
			try {
				...
				}, __vite__mapDeps([4,1,0,3,2]), import.meta.url);
		...
		async navigateSingletonShell(viewId) {
			try {
				const { bootLoader } = await __vitePreload(async () => {
					...
					return { bootLoader };
				}, __vite__mapDeps([5,6,1,7,8,9,10,11,12,13,14]), import.meta.url);
		...
		*/
		async pullCapacitorPendingOpen() {
			try {
				...
				}, __vite__mapDeps([8,1,9,6,7,10,11]), import.meta.url);
				...
				if (echo.hasFile) {
					...
					if (blob?.data) {
						const { dataUrlToFile } = await __vitePreload(async () => {
							const { dataUrlToFile } = await import("../chunks/sku-ingress.js");
							return { dataUrlToFile };
						}, __vite__mapDeps([15,9,6,1,8,7,10,11]), import.meta.url);
