...
/** Walk up from CWSP-process (and monorepo root) so hoisted workspace deps resolve. */
const findVitePkgRoot = () => {
    ...
    try {
        ...
        throw new Error(
            "Cannot find module 'vite/package.json'. Install CWSP-process deps:\n"
                + "  cd ~/U2RE.space && PUPPETEER_SKIP_DOWNLOAD=1 npm install -w cwsp-process --include=dev\n"
