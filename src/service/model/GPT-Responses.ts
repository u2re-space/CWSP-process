...
export const MAX_FILE_SIZE = MAX_DIRECT_FILE_BYTES;
export const MAX_BASE64_SIZE = MAX_DIRECT_FILE_BYTES;
...
export type RequestOptions = {
    ...
    /** Caller-owned cancellation signal for a request and its retry loop. */
    signal?: AbortSignal;
}
